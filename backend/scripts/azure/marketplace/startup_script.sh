...
# Env var indicating it is a Azure deployment.
echo "AZURE_MARKETPLACE_DEPLOYMENT=true" >> .env
...
echo "BIG_QUERY_TABLE=origin-214503.dshop.products" >> .env

# Change ownership of the .env file from root to dshop.
chown dshop .env
chgrp dshop .env
